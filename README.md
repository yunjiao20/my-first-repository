...
我跟随GitHub操作指南创建的第一个仓库，放了一些我初学时写的小脚本。下面的README内容是我
初学计算机时写的，当时花了我不少时间，懒得修改了。<br>
<br>
**AST.py**一个翻译不完整ASCLL和莫尔斯电码的小脚本，是我初学几天刚学到Python函数时写的，为了一个在纯HTML上找特殊字符的小想法<br>
**card_game.py**一个我刚学到Python类时写的命令行式的卡牌游戏，彼时不过初学几天，语法确有些丑陋了<br>
**game2048.py**一个纯命令行的2048小游戏，起源于我一个朋友想要写这个游戏的想法，但他最终没有写出来<br>
**lookfor.py**一个便于pwn寻找gadget的小脚本
